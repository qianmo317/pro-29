...
export const MOCK_TAGS: Tag[] = [
  { id: 'tag_1', name: '远程办公', color: '#0984E3' },
  { id: 'tag_2', name: '新员工', color: '#00B894' },
  { id: 'tag_3', name: '紧急', color: '#E17055' },
  { id: 'tag_4', name: 'VIP用户', color: '#E84393' },
  { id: 'tag_5', name: '重复发生', color: '#FDCB6E' },
  { id: 'tag_6', name: '待复盘', color: '#A29BFE' },
  { id: 'tag_7', name: '外部依赖', color: '#6C5CE7' },
]
...
export const MOCK_TICKETS: Ticket[] = [
  ...
  },
  {
    ...
    category: 'security', tags: ['tag_7'], priority: 'high', status: 'pending', creatorId: 'u6',
    assigneeId: null, departmentId: 'd3', createdAt: h(1), updatedAt: h(1), slaDeadline: f(5), knowledgeId: 'k4',
    mergedToId: null, mergedTicketIds: [], relatedTicketIds: ['TK-005'],
    deletedAt: null, deletedBy: null, archivedAt: null, archivedBy: null,
  },
  {
    id: 'TK-011', title: 'OA 系统流程审批异常', description: '报销审批流程在部门经理审批节点后卡住，无法流转到下一环节。',
    category: 'software', tags: ['tag_6'], priority: 'high', status: 'rejected', creatorId: 'u5',
  ...
  },
  {
    ...
    category: 'network', tags: [], priority: 'low', status: 'closed', creatorId: 'u6',
...
export const MOCK_RECORDS: TicketRecord[] = [
  { id: 'r1', ticketId: 'TK-001', operatorId: 'u5', action: 'created', content: '创建工单', createdAt: h(72), attachmentIds: [] },
  { id: 'r2', ticketId: 'TK-001', operatorId: 'u1', action: 'assigned', content: '将工单分配给李技术', createdAt: h(70), attachmentIds: [] },
  { id: 'r3', ticketId: 'TK-001', operatorId: 'u2', action: 'status_changed', content: '开始处理，已排查 VPN 服务器日志，发现内存泄漏问题', createdAt: h(48), attachmentIds: [] },
  { id: 'r4', ticketId: 'TK-001', operatorId: 'u2', action: 'comment', content: '已联系 VPN 厂商技术支持，等待补丁发布', createdAt: h(4), attachmentIds: [] },
  { id: 'r5', ticketId: 'TK-002', operatorId: 'u6', action: 'created', content: '创建工单', createdAt: h(48), attachmentIds: [] },
  { id: 'r6', ticketId: 'TK-002', operatorId: 'u1', action: 'assigned', content: '将工单分配给王运维', createdAt: h(47), attachmentIds: [] },
  { id: 'r7', ticketId: 'TK-003', operatorId: 'u5', action: 'created', content: '创建工单 - 紧急！财务部无法正常工作', createdAt: h(6), attachmentIds: [] },
  { id: 'r8', ticketId: 'TK-004', operatorId: 'u6', action: 'created', content: '创建工单', createdAt: h(36), attachmentIds: [] },
  { id: 'r9', ticketId: 'TK-004', operatorId: 'u1', action: 'assigned', content: '将工单分配给赵开发', createdAt: h(35), attachmentIds: [] },
  { id: 'r10', ticketId: 'TK-004', operatorId: 'u4', action: 'status_changed', content: '开始排查邮件服务器，发现队列堵塞', createdAt: h(20), attachmentIds: [] },
  { id: 'r11', ticketId: 'TK-004', operatorId: 'u4', action: 'comment', content: '正在清理邮件队列，预计 2 小时内恢复', createdAt: h(2), attachmentIds: [] },
  { id: 'r12', ticketId: 'TK-005', operatorId: 'u5', action: 'created', content: '创建工单', createdAt: h(96), attachmentIds: [] },
  { id: 'r13', ticketId: 'TK-005', operatorId: 'u1', action: 'assigned', content: '将工单分配给李技术', createdAt: h(95), attachmentIds: [] },
  { id: 'r14', ticketId: 'TK-005', operatorId: 'u2', action: 'status_changed', content: '已配置防火墙规则，等待确认', createdAt: h(12), attachmentIds: [] },
  { id: 'r15', ticketId: 'TK-005', operatorId: 'u2', action: 'status_changed', content: '设置状态为待确认', createdAt: h(8), attachmentIds: [] },
  { id: 'r16', ticketId: 'TK-006', operatorId: 'u6', action: 'created', content: '创建工单', createdAt: h(168), attachmentIds: [] },
  { id: 'r17', ticketId: 'TK-006', operatorId: 'u3', action: 'status_changed', content: '安装兼容驱动程序，测试打印正常', createdAt: h(48), attachmentIds: [] },
  { id: 'r18', ticketId: 'TK-006', operatorId: 'u6', action: 'confirmed', content: '确认问题已解决', createdAt: h(24), attachmentIds: [] },
  { id: 'r19', ticketId: 'TK-007', operatorId: 'u5', action: 'created', content: '创建工单', createdAt: h(24), attachmentIds: [] },
  { id: 'r20', ticketId: 'TK-007', operatorId: 'u4', action: 'status_changed', content: '开始排查 LDAP 认证服务', createdAt: h(3), attachmentIds: [] },
  { id: 'r21', ticketId: 'TK-009', operatorId: 'u5', action: 'created', content: '创建工单 - 备份失败需紧急处理', createdAt: h(3), attachmentIds: [] },
  { id: 'r22', ticketId: 'TK-009', operatorId: 'u1', action: 'assigned', content: '将工单分配给王运维', createdAt: h(2.5), attachmentIds: [] },
  { id: 'r23', ticketId: 'TK-009', operatorId: 'u3', action: 'status_changed', content: '开始排查，检查备份服务器存储空间', createdAt: h(1), attachmentIds: [] },
  { id: 'r24', ticketId: 'TK-010', operatorId: 'u6', action: 'created', content: '创建工单', createdAt: h(1), attachmentIds: [] },
  { id: 'r25', ticketId: 'TK-011', operatorId: 'u5', action: 'created', content: '创建工单', createdAt: h(120), attachmentIds: [] },
  { id: 'r26', ticketId: 'TK-011', operatorId: 'u4', action: 'comment', content: '修复方案被驳回，需要重新设计方案', createdAt: h(48), attachmentIds: [] },
  { id: 'r27', ticketId: 'TK-006', operatorId: 'u6', action: 'evaluated', content: '提交评价：5 星，处理很及时，驱动安装后打印恢复正常', createdAt: h(20), attachmentIds: [] },
  { id: 'r28', ticketId: 'TK-012', operatorId: 'u6', action: 'evaluated', content: '提交评价：3 星，布线完成但整体耗时偏长', createdAt: h(70), attachmentIds: [] },
]
